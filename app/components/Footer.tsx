          ...
          <div className="flex gap-3">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M12.271 17.218c-1.151 0-2.033.868-2.033 2.019 0 1.151.882 2.033 2.033 2.033 1.15 0 2.033-.882 2.033-2.033-.001-1.151-.883-2.019-2.033-2.019zm0-14.218C6.623 3 2 7.623 2 13.271S6.623 23.542 12.271 23.542 22.542 18.919 22.542 13.271 17.919 3 12.271 3z" />
              </svg>
            </a>
          </div>
